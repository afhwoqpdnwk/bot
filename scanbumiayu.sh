...
FILE_PATH="/root/List-IP-BUMIAYU.txt"
API_URL="https://api.telegram.org/bot$TOKEN_BOT/sendDocument" 
rm bumiayu.txt
wget -O bumiayu.txt https://raw.githubusercontent.com/bmayu1/izin/main/ip
wget -O - https://raw.githubusercontent.com/BmyVpn/bumiayuvpn/main/izin >> bumiayu.txt
...
done < bumiayu.txt > List-IP-BUMIAYU.txt
